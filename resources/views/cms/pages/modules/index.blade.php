...
<div class="page-breadcrumb">
    <div class="row">
        <div class="col-5 align-self-center">
            <h4 class="page-title">Cadastrar página / módulo</h4>
        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Cadastrar página / módulo</h4>
                    <h6 class="card-subtitle">Adicione uma página ou módulo ao site através desse formulário abaixo.</h6>
                </div>
                <hr class="m-t-0">
